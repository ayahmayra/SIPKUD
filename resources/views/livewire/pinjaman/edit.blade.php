<div class="flex h-full w-full flex-1 flex-col gap-6" 
    ...
    <div>
        <flux:heading size="xl">Edit Pinjaman</flux:heading>
        <flux:heading size="sm" class="mt-2 text-zinc-600 dark:text-zinc-400">
            Edit data pinjaman: {{ $pinjaman->nomor_pinjaman }}
        </flux:heading>
    </div>
    ...
    <flux:card class="p-6">
        <form wire:submit="update" class="space-y-6">
            <flux:input 
                wire:model="pinjaman.nomor_pinjaman" 
                label="Nomor Pinjaman" 
                disabled
            />
            <flux:text class="text-xs text-zinc-500">
                Nomor pinjaman tidak dapat diubah
            </flux:text>
