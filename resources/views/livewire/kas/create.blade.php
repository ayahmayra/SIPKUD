<div class="flex h-full w-full flex-1 flex-col gap-6">
    <div>
        <flux:heading size="xl">Tambah Transaksi Kas</flux:heading>
        <flux:heading size="sm" class="mt-2 text-zinc-600 dark:text-zinc-400">
            Input transaksi kas harian (otomatis membuat jurnal)
        </flux:heading>
    </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700 dark:text-blue-300">
                            <p>Jurnal akan otomatis dibuat setelah menyimpan transaksi ini dengan prinsip double-entry.</p>
                        </div>
                    </div>
                </div>
            </div>
