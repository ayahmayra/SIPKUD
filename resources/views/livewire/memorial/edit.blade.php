<div class="flex h-full w-full flex-1 flex-col gap-6">
    <div>
        <flux:heading size="xl">Edit Jurnal Memorial</flux:heading>
        <flux:heading size="sm" class="mt-2 text-zinc-600 dark:text-zinc-400">
            Edit jurnal memorial (hanya status draft yang bisa diedit)
        </flux:heading>
    </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700 dark:text-blue-300">
                            <p>Hanya jurnal dengan status "Draft" yang dapat diedit. Total Debit harus sama dengan Total Kredit.</p>
                        </div>
                    </div>
                </div>
            </div>
